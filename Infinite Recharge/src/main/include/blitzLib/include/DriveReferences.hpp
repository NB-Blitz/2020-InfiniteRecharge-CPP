...
namespace Blitz
{
    ...
    {
        public:
            static constexpr int LEFT_FRONT_MOTOR_ID = 4;
            static constexpr int LEFT_BACK_MOTOR_ID = 3;
            static constexpr int RIGHT_FRONT_MOTOR_ID = 1;
            static constexpr int RIGHT_BACK_MOTOR_ID = 2;
